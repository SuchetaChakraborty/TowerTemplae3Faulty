...
//level 2
box8=new Box(330,485,30,40);
box9=new Box(360,485,30,40);
box10=new Box(390,485,35,40);
box11=new Box(420,485,30,40);
box12=new Box(450,485,30,40);

//level 3
box13=new Box(360,445,30,40);
box14=new Box(390,445,30,40);
box15=new Box(420,445,30,40);

//level 4
box16=new Box(390,435,30,40);
...
text( "Your score is " + score, 750, 40);
